        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[70vh] px-6 text-center">
          <div className="max-w-4xl mx-auto relative z-20">
            ...
            <div className="inline-flex items-center px-4 py-2 bg-green-50 text-green-600 rounded-full text-sm font-medium mb-6 border border-green-100">
              ...
              Klarert av 2,500+ aktive brukere
            </div>
            ...
            {/* Trust Indicators */}
            <div className="flex flex-col sm:flex-row items-center justify-center mt-8 space-y-4 sm:space-y-0 sm:space-x-8 text-sm text-slate-600">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p 
                ...
                style={{ fontFamily: 'Satoshi-Regular' }}
              >
                Bli med i tusenvis av fornøyde brukere som har transformert sin markedsføring med QRlab
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-slate-700 mb-6 leading-relaxed" style={{ fontFamily: 'Satoshi-Regular' }}>
                  &ldquo;QRlab har revolusjonert hvordan vi sporer vår offline markedsføring. Analytics-dataene er uvurderlige for å optimalisere kampanjene våre.&rdquo;
                </p>
                <div className="flex items-center">
              ...
              <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-slate-700 mb-6 leading-relaxed" style={{ fontFamily: 'Satoshi-Regular' }}>
                  &ldquo;Enkelt å lage QR-menyer og oppdatere dem. Kundene elsker hvor lett det er å se menyen på telefonen.&rdquo;
                </p>
                <div className="flex items-center">
              ...
              <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-slate-700 mb-6 leading-relaxed" style={{ fontFamily: 'Satoshi-Regular' }}>
                  &ldquo;Bruker QRlab for alle våre events. Bulk-genereringen sparer oss timer, og rapportene gir oss innsikt i deltagerengasjement.&rdquo;
                </p>
                <div className="flex items-center">
